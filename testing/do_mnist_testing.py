...
from ExperimentWrapper_testing import ExperimentWrapper, ExperimentConfig
...
if __name__ == '__main__':
    ...
    this_experiment.train_a3(
        ...
        show_metrics=True, automatic_weights=False,
        is_subfolder=False
    )

    # Train the baselines if applicable
    try:
        ...
        print(f"Baselines not trained: {e}")
        pass
